...
console.log('--- Updating Bento Face (v9 - Chroma Keyed) ---');
// Update Bento Xavier Costa
const info = db.prepare("UPDATE base_players SET image_url = '/assets/players/bento_face_v9.png' WHERE ea_player_id = 'custom_bento_001'").run();
