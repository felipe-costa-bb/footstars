...
console.log('--- Updating Bento Face (v21 - Transparency Fix) ---');
// Update Bento Xavier Costa
const info = db.prepare("UPDATE base_players SET image_url = '/assets/players/bento_face_v21.png' WHERE ea_player_id = 'custom_bento_001'").run();
