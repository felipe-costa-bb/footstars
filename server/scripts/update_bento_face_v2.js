...
console.log('--- Updating Bento Face (v2) ---');
// Update Bento Xavier Costa
const info = db.prepare("UPDATE base_players SET image_url = '/assets/players/bento_face_v2.png' WHERE ea_player_id = 'custom_bento_001'").run();
